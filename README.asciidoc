...
// | <Leader>cr | recompile                    |
| <Leader>cl | 注释选中行                    |
| <Leader>c+动作 | 注释。如<Leader>cip注释一个段落                      |
|===
...
|===
| 快捷键          | 用途             | 所属插件
| <Leader>xa+动作 | 对齐文本         | vim-easy-align
| <Leader>xdw     | 删除行尾空白字符 | 内置
...
|===
| 快捷键      | 用途                          | 所属插件
| <Leader>ti  | 切换高亮显示indentation guide | indentLine
| <Leader>tw  | 切换高亮显示行尾空白字符      | vim-airline
| <Leader>tn  | 切换显示行号                  | 内置
| <Leader>tr  | 切换相对行号                  | 内置
| <Leader>tha | 切换高亮当前词                | 内置
